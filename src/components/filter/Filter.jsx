...
import filterLowerCardData from "../../Data/filterLowerCardData";
        ...
        <div className="row">
            ...
            <div className="shop-product-fillter-header">
              <div className="row">
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 mb-lg-0 mb-md-2 mb-sm-2">
                  {loading ? (
                    <Skeleton
                      style={{ borderRadius: "15px", height: "450px" }}
                    />
                  ) : (
                    <div className="card">
                ...
                <div className="col-xl-3 col-lg-6 col-md-6 mb-lg-0 mb-md-2 mb-sm-2">
                  {loading ? (
                    <Skeleton
                      style={{ borderRadius: "15px", height: "550px" }}
                    />
                  ) : (
                    <div className="card">
          ...
          <div className="col-12">
            ...
            <section className="section-padding pb-5">
              ...
              <div className="row">
                {filterLowerCardData.map((item, i) => (
                  <FilterLowerCard key={i} className={item.class} />
                ))}
              </div>
            </section>
            {/* <!--End Deals--> */}
